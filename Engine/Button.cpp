...
void Button::RenderUI(class Renderer& renderer)
{
	...
	case Button::ButtonState::Idle:
		renderer.UI_RENDER_FUNCTIONS().emplace_back([texidle, pos, offset_idle, scale_idle, color_idle, depth]() {
	...
	case Button::ButtonState::Hoverd:
		renderer.UI_RENDER_FUNCTIONS().emplace_back([texhoverd, pos, offset_hoverd, scale_hoverd, color_hoverd, depth]() { 
	...
	case Button::ButtonState::Pressed:
		renderer.UI_RENDER_FUNCTIONS().emplace_back([texpressed, pos, offset_pressed, scale_pressed, color_pressed, depth]() {
	...
	case Button::ButtonState::Clicked:
		renderer.UI_RENDER_FUNCTIONS().emplace_back([texclicked, pos, offset_clicked, scale_clicked, color_clicked, depth]() { 
